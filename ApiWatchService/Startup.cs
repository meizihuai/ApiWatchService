...
namespace ApiWatchService
{
    public class Startup
    {
        ...
        {
            //依赖注入
            services.Configure<WarnPushInfo>(Configuration.GetSection("WarnPusher"));
            services.Configure<List<ApiWatchInfo>>(Configuration.GetSection("ApiWatchInfos"));
            services.AddSingleton<ILoopWorker, ApiServiceWatcher>();
            services.AddSingleton<IWarnPusher, WarnPushEmailImpl>();
            services.AddSingleton<IWarnPusher, WarnPushServerChanImpl>();
